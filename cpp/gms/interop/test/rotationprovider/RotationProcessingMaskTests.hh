#ifndef ROTATION_PROCESSING_MASK_TEST
#define ROTATION_PROCESSING_MASK_TEST
...
*/
class RotationProcessingMaskTests : public ::testing::Test
{
public:
    void SetUp() override;
...
#endif // ROTATION_PROCESSING_MASK_TEST