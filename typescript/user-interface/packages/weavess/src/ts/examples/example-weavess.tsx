  ...
  public render(): JSX.Element {
    ...
    const onKeyPress = this.state.isOnKeyPressEnabled
      ? (
          ...
          toast.info(
            `onKeyPress: clientX:${clientX} clientY:${clientY} channelId:${channel.id} timeSecs:${timeSecs}`
          );
        }
      : undefined;
                    ...
                    onChange={() =>
                      this.setState(prevState => ({
                        isOnSignalDetectionDragEndEnabled:
                          !prevState.isOnSignalDetectionDragEndEnabled
                      }))
                    }
                  />
                </div>
                    ...
                    onChange={() =>
                      this.setState(prevState => ({
                        isOnSignalDetectionContextMenuEnabled:
                          !prevState.isOnSignalDetectionContextMenuEnabled
                      }))
                    }
                  />
                </div>
                    ...
                    onChange={() =>
                      this.setState(prevState => ({
                        isOnPredictivePhaseContextMenuEnabled:
                          !prevState.isOnPredictivePhaseContextMenuEnabled
                      }))
                    }
                  />
                </div>
                    ...
                    onChange={() =>
                      this.setState(prevState => ({
                        isOnClickSelectionWindowsEnabled:
                          !prevState.isOnClickSelectionWindowsEnabled
                      }))
                    }
                  />
                </div>
