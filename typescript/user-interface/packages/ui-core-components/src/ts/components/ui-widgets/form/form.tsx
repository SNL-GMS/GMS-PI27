 ...
 * @param elementsLeftOfSubmitButton simply renders the provided elements to the left of the submit button
...
export interface FormProps {
  ...
  elementsLeftOfSubmitButton?: JSX.Element[];
...
export class Form extends React.Component<FormProps, FormState> {
  ...
  private readonly setMaxLengthString = (): number => {
  ...
  private readonly onSubmitClick = () => {
  ...
  public render(): JSX.Element {
    ...
    const maxLengthString = this.setMaxLengthString();
    ...
    const buttonLabel = this.props.submitButtonText ? this.props.submitButtonText : 'Submit';
    const buttonTitle =
      ...
      <div className="form">
        ...
        <div className="form__buttons">
          <div className="form__buttons--right">
            ...
            {this.props.elementsLeftOfSubmitButton}
            <Button
              className="form__button"
