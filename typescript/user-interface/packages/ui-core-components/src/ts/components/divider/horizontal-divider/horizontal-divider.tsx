...
> {
    ...
    return (
      ...
      >
        ...
        <DragHandleDivider
          ...
          onDrag={e => {
            this.onThumbnailHorizontalDividerDrag(e);
            this.props.setFocusToDisplay();
          }}
        />
        <div
  ...
  public readonly getTopContainerHeight = (): number => {
    const topComponentHeightPxZero = this.props.topHeightPx
      ? this.props.topHeightPx
      : this.defaultHeight;
    // pixelHeight
    return this.state.topComponentHeightPx === 0
      ? topComponentHeightPxZero
  ...
  private readonly verifyMinDefinedHeights = () => {
    const minDefinedHeight =
      (this.props.sizeRange?.minimumBottomHeightPx || 0) +
      (this.props.sizeRange?.minimumTopHeightPx || 0) +
      this.handleHeight;
