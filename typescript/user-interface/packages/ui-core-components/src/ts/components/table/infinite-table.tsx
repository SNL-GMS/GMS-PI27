...
import type { GridReadyEvent, IDatasource, IGetRowsParams } from 'ag-grid-community';
...
> {
  ...
  private coreTableRef: CoreTable<RowDataType, ContextDataType> | null;
  ...
  public readonly destroy = (): void => {
    if (this.getTableApi() && this.coreTableRef) {
    ...
    this.coreTableRef = null;
  };

  /**
   * Returns the Table Api instance.
   */
  public readonly getTableApi = (): TableApi | undefined => this.coreTableRef?.getTableApi();

  /**
   * Returns the Column Api instance.
   */
  public readonly getColumnApi = (): ColumnApi | undefined => this.coreTableRef?.getColumnApi();

  /**
   * Returns the number of visible columns.
   */
  public readonly getNumberOfVisibleColumns = (): number =>
    this.coreTableRef?.getNumberOfVisibleColumns() || 0;
