 ...
 */
function TableCellComponent(props: TableCellRendererProps) {
    ...
    >
      ...
      {value ? (
        <div
          className={classList(
            {
              'table-cell__value--date': isDate || false,
              'table-cell__value--numeric': isNumeric || false,
              'table-cell__value--center': shouldCenterText || false
            },
