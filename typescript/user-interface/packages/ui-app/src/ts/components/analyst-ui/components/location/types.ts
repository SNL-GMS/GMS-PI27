...
import type { SignalDetectionSnapshot } from '@gms/common-model/lib/event/legacy';
...
export interface LocationMutations {
  ...
  deleteDetections: (args: any) => Promise<void>;
...
export interface SignalDetectionSnapshotWithDiffs extends SignalDetectionSnapshot {
  diffs: LocationSDRowDiffs;
  deletedOrUnassociated: boolean;
}
