...
/**
 * Sets focus to station properties
 */
export function setFocusToStationPropertiesDisplay(): void {
  const stationPropertiesPanel = document.getElementsByClassName('station-properties-panel');
  const stationPropertiesPanelElement = stationPropertiesPanel[0].parentElement;
  stationPropertiesPanelElement?.focus();
}
