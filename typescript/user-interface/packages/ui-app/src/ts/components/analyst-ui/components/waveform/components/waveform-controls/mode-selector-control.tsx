...
const buildModeSelector = (
  ...
  <DropdownToolbarItem<typeof AnalystWorkspaceTypes.WaveformDisplayMode>
    key={key}
    label="Mode"
    tooltip="Set the display mode"
    value={measurementMode.mode}
    disabled
    onChange={value => setMode(value as AnalystWorkspaceTypes.WaveformDisplayMode)}
    dropDownItems={AnalystWorkspaceTypes.WaveformDisplayMode}
    widthPx={widthPx}
  />
);
