...
import type { ChannelTypes, CommonTypes, ResponseTypes, StationTypes } from '@gms/common-model';
import {
  delayExecutionReturnClearTimeout,
...
function parseChannelLocation(location: CommonTypes.Location) {
  return {
...
function formatChannelConfigurationTableRows(
  ...
  return channels.map((chan: ChannelTypes.Channel, idx: number): ChannelConfigurationRow => {
    ...
    return {
      ...
      description: chan.description
        ? getTableCellStringValue(toSentenceCase(chan.description.replace(/_/g, ' ')))
        : messageConfig.invalidCellText,
      ...
      effectiveUntil: chan.effectiveUntil
        ...
        : toSentenceCase(messageConfig.latestVersionCellText),
      calibrationFactor,
      calibrationPeriod,
      calibrationStandardDeviation,
      calibrationTimeShift,
      ...
      orientationHorizontalDegrees:
        chan.orientationAngles && chan.orientationAngles.horizontalAngleDeg != null
          ? formatNumberForDisplayMaxThreeDecimalPlaces(chan.orientationAngles.horizontalAngleDeg)
          : messageConfig.invalidCellText,
      orientationVerticalDegrees:
        chan.orientationAngles && chan.orientationAngles.verticalAngleDeg != null
...
export function ChannelConfigurationTable(props: ChannelConfigurationTableProps) {
