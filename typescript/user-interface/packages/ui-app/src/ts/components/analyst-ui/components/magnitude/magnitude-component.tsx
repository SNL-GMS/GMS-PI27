...
export class Magnitude extends React.Component<MagnitudeProps, MagnitudeComponentState> {
  ...
  public componentDidMount(): void {
    addGlUpdateOnShow(this.props.glContainer, this.updateGl);
    addGlUpdateOnResize(this.props.glContainer, this.updateGl);
  }
  ...
  public componentWillUnmount(): void {
    clearGlUpdateOnShow(this.props.glContainer, this.updateGl);
    clearGlUpdateOnResize(this.props.glContainer, this.updateGl);
  }
