      ...
      children: [
        {
          ...
          sortable: true,
          filter: true,
          cellRenderer: AddedRemovedSDMarker
        },
        {
          headerName: 'Station',
          field: 'station',
          ...
          cellStyle: (params: any) => ({
            'text-align': 'left',
            color:
              historicalMode || params.data.deletedOrUnassociated ? gmsColors.gmsSoft : undefined
          }),
          resizable: true,
          sortable: true,
          filter: true,
      ...
      children: [
        {
          ...
          filter: true,
          suppressMovable: true,
          cellRenderer: DefiningCheckBoxCellRenderer,
          cellStyle: (params: any) => ({
            display: 'flex',
            'justify-content': 'center',
            'padding-left': '9px',
