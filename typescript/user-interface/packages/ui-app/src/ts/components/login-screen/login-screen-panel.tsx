 ...
 */
export class LoginScreenPanel extends React.Component<
  LoginScreenProps & { searchParams: URLSearchParams },
  LoginScreenState
> {
  /** unique timer id used for attempting reconnects to the gateway */
  private reconnectTimerId: number | undefined = undefined;

  public constructor(props: LoginScreenProps & { searchParams: URLSearchParams }) {
    super(props);
    this.state = {
      username: undefined,
  ...
  public componentDidMount(): void {
    ...
    if (uiTheme) {
      injectTheme(uiTheme);
      this.setState({ isDarkMode: uiTheme.isDarkMode ?? true });
    }
  ...
  private readonly getPreviouslyLoadedUiTheme = (): ConfigurationTypes.UITheme | undefined => {
  ...
  public render(): JSX.Element {
    ...
    const from = {
      ...
      search: this.props.searchParams ? `?${this.props.searchParams}` : undefined
    };
