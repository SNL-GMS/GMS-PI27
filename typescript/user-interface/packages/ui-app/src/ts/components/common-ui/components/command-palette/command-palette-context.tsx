...
export interface CommandPaletteContextData {
  ...
  registerCommands: (commandsToRegister: Command[], scope: CommandScope) => void;
  setCommandPaletteVisibility: (visibility: boolean) => void;
}

export const CommandPaletteContext: React.Context<CommandPaletteContextData> =
  React.createContext<CommandPaletteContextData>(undefined);
