...
export abstract class AbstractKafka implements IKafka {
  ...
  protected reconnectTimeoutId: ReturnType<typeof setTimeout> | undefined;
   ...
   */
  public readonly getStatusHistoryInformationAsObject = (): Record<string, unknown> => {
   ...
   */
  public readonly getUpTime = (): Date | undefined => this.upTime;
