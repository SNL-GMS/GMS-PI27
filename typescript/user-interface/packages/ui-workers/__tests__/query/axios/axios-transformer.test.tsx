...
describe('axios response transformers', () => {
  ...
  it('axios query succeeds with default response transformer', async () => {
    ...
    const result = await axiosBaseQuery({ baseUrl: '' })({ requestConfig }, {} as BaseQueryApi, {});
  ...
  it('instance json fields', () => {
    expect(TimeTypes.JSON_INSTANT_NAMES).toMatchInlineSnapshot(`
      [
        "creationTime",
  ...
  it('duration json fields', () => {
    expect(TimeTypes.JSON_DURATION_NAMES).toMatchInlineSnapshot(`
      [
        "beamDuration",
