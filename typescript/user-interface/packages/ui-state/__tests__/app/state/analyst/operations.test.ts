    ...
    describe('open event', () => {
      ...
      it('should set the open event (undefined)', () => {
        ...
        const expectedActions = [
          ...
          {
            type: fksSlice.actions.setDisplayedSignalDetectionId.type,
            payload: ''
          },
          {
      ...
      it('should set the open event', () => {
        ...
        const expectedActions = [
          ...
          {
            type: analystSlice.actions.setSelectedSortType.type,
            payload: AnalystWorkspaceTypes.WaveformSortType.distance
          },
          {
            type: analystSlice.actions.setSelectedSdIds.type,
            payload: []
        ...
        store.dispatch(AnalystWorkspaceOperations.setOpenEventId(eventData, undefined, undefined));
        const actions = store.getActions();
        expect(actions).toEqual(expectedActions);
      });
    });
