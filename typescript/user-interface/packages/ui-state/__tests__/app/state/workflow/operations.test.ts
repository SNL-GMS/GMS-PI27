...
describe('workflow operations', () => {
  ...
  it.skip('should open an interval', () => {
    const mockAppState = cloneDeep(getStore().getState());
  ...
  it.skip('should open an interval with no change', () => {
    const updatedInitialState: AppState = cloneDeep(getStore().getState());
    updatedInitialState.app = cloneDeep(mockInitialAppState);
  ...
  it('should close an interval activity', () => {
    ...
    const mockAppState: AppState = cloneDeep(getStore().getState());
    mockAppState.app = {
      ...mockInitialAppState,
      analyst: {
