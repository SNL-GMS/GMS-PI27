...
import { StationType, Units } from '@gms/common-model/lib/common/types';
...
const eventFeatureMeasurement: SignalDetectionTypes.FeatureMeasurement = {
  ...
  snr: { value: 3, units: Units.COUNTS_PER_NANOMETER, standardDeviation: 0 },
  measurementValue: {
    value: 'P',
    confidence: 0.5,
...
const featurePrediction: EventTypes.FeaturePrediction = {
  ...
  predictionType: FeatureMeasurementType.AMPLITUDE_A5_OVER_2,
  receiverLocation: { depthKm: 4, latitudeDegrees: 3, longitudeDegrees: 3, elevationKm: 1 },
                  ...
                  channels: [
                    {
                      ...
                      response: {
                        ...
                        fapResponse: {
                          id: 'test',
                          amplitudeResponse: [],
                          amplitudeResponseStdDev: [],
                          amplitudeResponseUnits: [],
                          frequencies: [],
                          phaseResponse: [],
                          phaseResponseStdDev: [],
                          phaseResponseUnits: []
