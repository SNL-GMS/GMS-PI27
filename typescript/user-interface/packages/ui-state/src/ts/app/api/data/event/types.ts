 ...
 */
export type GetEventsWithDetectionsAndSegmentsByTimeHistory =
  AsyncFetchHistory<GetEventsWithDetectionsAndSegmentsByTimeQueryArgs>;

export interface FindEventsByAssociatedSignalDetectionHypothesesQueryArgs {
  signalDetectionHypotheses: SignalDetectionTypes.SignalDetectionHypothesis[];
  stageId: { name: string };
}

export type FindEventsByAssociatedSignalDetectionHypothesesHistory =
  AsyncFetchHistory<FindEventsByAssociatedSignalDetectionHypothesesQueryArgs>;
