...
export const workflowInitialState: WorkflowState = {
  ...
  stationGroup: { effectiveAt: -1, name: '', description: '' },
  openIntervalName: '',
  openActivityNames: [],
  analysisMode: null
};
...
export const workflowSlice = createSlice({
  ...
  reducers: {
     ...
     */
    setTimeRange(state, action: PayloadAction<Nullable<CommonTypes.TimeRange>>) {
     ...
     * @param action the action
     */
    setAnalysisMode(state, action: PayloadAction<WorkflowTypes.AnalysisMode | null>) {
