 ...
 */
export const setCommandPaletteVisibility =
  (visibility: boolean) =>
 ...
 */
export const idsHaveChanged =
  (ids: string[]): ((getState: () => AppState) => boolean) =>
  (getState: () => AppState): boolean => {
 ...
 */
export const setSelectedStationIds =
  (ids: string[]) =>
  (dispatch: AppDispatch, getState: () => AppState): void => {
 ...
 */
export const setGlDisplayState =
