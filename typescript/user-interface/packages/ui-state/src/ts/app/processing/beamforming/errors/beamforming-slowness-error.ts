...
export class BeamformingSlownessError extends BeamformingWithStationError {
  ...
  public constructor(
    ...
    super(`Cannot create beam. No slowness found.`, station, 'beamforming-invalid-slowness');
