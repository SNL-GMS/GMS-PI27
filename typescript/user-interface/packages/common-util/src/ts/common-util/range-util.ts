 ...
 */
export const mergeRanges = (ranges: Range[] | undefined): Range[] => {
 ...
 */
export const determineExcludedRanges = (
  ranges: Range[] | undefined | null,
  ...
  const determineMerge = (s: Range, r: Range) => {
 ...
 */
export const chunkRange = (range: Range | undefined, maxSize: number): Range[] => {
 ...
 * @returns an array of ranges where the size is <= the maximum size
 */
export const chunkRanges = (ranges: Range[] | undefined, maxSize: number): Range[] => {
  const chunkedRanges: Range[] = [];
