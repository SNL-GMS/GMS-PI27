...
import { uniqSortStrings } from '../../src/ts/common-util';
...
const millis =
  MILLISECONDS_IN_WEEK + MILLISECONDS_IN_DAY + MILLISECONDS_IN_MINUTE + MILLISECONDS_IN_SECOND * 30;
...
describe('Time Utils', () => {
  test(`Is exported`, () => {
    ...
    expect(uniqSortStrings).toBeDefined();
  ...
  test('uniqSortStrings', () => {
    expect(uniqSortStrings(['test1', 'testa', 'testa', 'testA', 'testB'])).toMatchInlineSnapshot(`
      [
        "test1",
        "testA",
        "testB",
