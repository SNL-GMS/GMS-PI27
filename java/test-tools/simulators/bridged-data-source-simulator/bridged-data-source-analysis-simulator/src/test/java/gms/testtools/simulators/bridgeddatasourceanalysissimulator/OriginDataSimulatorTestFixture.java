...
public class OriginDataSimulatorTestFixture {
  ...
  public static WfTagDao happyWftagDao = CSSDaoTestFixtures.createWfTagDao(1, 1, TagName.EVID);

  public static EventControlDao.Builder happyEventControlDao =
      new EventControlDao.Builder()
          .withEventIdOriginIdKey(
              new EventIdOriginIdKey.Builder().withOriginId(1).withEventId(1).build())
  ...
  public static AssocDao.Builder happyAssocDaoBuilder =
      new AssocDao.Builder()
          .withId(new AridOridKey.Builder().withOriginId(1).withArrivalId(1).build())
          .withStationCode("AA")
          .withPhase("P")
          .withBelief(1.0)
          .withDelta(1.0)
  ...
  public static ArInfoDao.Builder happyArInfoDaoBuilder =
      new ArInfoDao.Builder()
          .withOriginIdArrivalIdKey(
              new OriginIdArrivalIdKey.Builder().withOriginId(1).withArrivalId(1).build())
          .withTimeErrorCode(1)
  ...
  public static NetMagDao.Builder happyNetMagDaoBuilder =
  ...
  public static StaMagDao.Builder happyStaMagDaoBuilder =
