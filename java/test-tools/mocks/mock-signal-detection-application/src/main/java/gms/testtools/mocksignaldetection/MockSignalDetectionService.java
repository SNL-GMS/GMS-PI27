...
public interface MockSignalDetectionService {
  ...
  @Operation(
      summary =
          "retrieves all signal detections and associated with channel segments specified by the"
              + " provided stations, time range, stage, and excluding all signal detections having"
              + " any of the provided signal detection ids")
  SignalDetectionsWithChannelSegments findDetectionsWithSegmentsByStationsAndTime(
      @RequestBody(
              description =
                  "A list of "
