...
public class FileStoreTestFixture {
  ...
  static class DeserializedTestClass1 {
    ...
    public DeserializedTestClass1(
        String stringField, Double doubleField, Map<String, Integer> mapField) {
  ...
  static class DeserializedTestClass2 {
    ...
    public DeserializedTestClass2(
        String stringField, Double doubleField, Integer integerField1, Integer integerField2) {
      this.stringField = stringField;
      this.doubleField = doubleField;
    ...
    public boolean equals(Object o) {
      ...
      return Objects.equals(stringField, that.stringField)
          && Objects.equals(doubleField, that.doubleField)
          && Objects.equals(integerField1, that.integerField1)
  ...
  static class TestFileTransformer1 implements FileTransformer<DeserializedTestClass2> {
    ...
    public DeserializedTestClass2 transform(InputStream rawDataStream) {
      try {
        var intermediate =
            ObjectMappers.jsonMapper().readValue(rawDataStream, DeserializedTestClass1.class);
