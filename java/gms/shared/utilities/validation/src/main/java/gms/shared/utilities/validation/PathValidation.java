...
/**
 * A class used to validate paths have an expected starting point to prevent potential security
...
public final class PathValidation {
  ...
  /**
   * Returns path from string after validating it against the base path. If the string path is not
   * in the base path, throws and IllegalArgumentException
   *
   ...
   */
  public static Path getValidatedPath(String path, String expectedBasePath, String... more)
