...
class WaveformTrimDefinitionTest {
  ...
  void testCreateValidation(
    ...
    IllegalStateException exception =
        assertThrows(
            ...
            () ->
                WaveformTrimDefinition.create(
                    measuredWaveformLeadDuration, measuredWaveformLagDuration));
  ...
  void testSerialization() throws IOException {
    WaveformTrimDefinition definition =
        WaveformTrimDefinition.create(Duration.ofHours(1), Duration.ofHours(2));
    JsonTestUtilities.assertSerializes(definition, WaveformTrimDefinition.class);
  }
}
