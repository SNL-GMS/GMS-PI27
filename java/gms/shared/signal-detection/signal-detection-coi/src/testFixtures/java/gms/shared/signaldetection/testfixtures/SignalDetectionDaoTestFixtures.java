...
public final class SignalDetectionDaoTestFixtures {
  ...
  public static final AmplitudeDao AMPLITUDE_DAO;
  public static final AmplitudeDao AMPLITUDE_DAO_AMPTYPE_SBSNR;
  ...
  public static final long AMPID2 = 700;
  public static final String STA = "TEST";
  public static final String A5_2 = "A5/2";
  public static final String SBSNR = "SBSNR";
  ...
  static {
    ...
    ASSOC_DAO_1.setId(new AridOridKey.Builder().withOriginId(ORID_1).withArrivalId(ARID).build());
    ...
    ASSOC_DAO_2.setId(new AridOridKey.Builder().withOriginId(ORID_1).withArrivalId(ARID).build());
    ...
    ASSOC_DAO_3.setId(new AridOridKey.Builder().withOriginId(ORID_1).withArrivalId(ARID).build());
    ...
    ASSOC_DAO_4.setId(new AridOridKey.Builder().withOriginId(ORID_1).withArrivalId(ARID).build());
    ...
    AMPLITUDE_DAO = new AmplitudeDao();
    AMPLITUDE_DAO.setId(AMPID);
    AMPLITUDE_DAO.setArrivalId(ARID);
    AMPLITUDE_DAO.setPredictedArrivalId(ARID);
    AMPLITUDE_DAO.setChannelCode(CHAN);
    AMPLITUDE_DAO.setAmplitude(432.23);
    AMPLITUDE_DAO.setPeriod(DEFAULT_PERIOD);
    AMPLITUDE_DAO.setSnr(DEFAULT_DOUBLE);
    AMPLITUDE_DAO.setAmplitudeTime(DEFAULT_INSTANT);
    AMPLITUDE_DAO.setTime(DEFAULT_INSTANT);
    AMPLITUDE_DAO.setDuration(DEFAULT_DURATION);
    AMPLITUDE_DAO.setSampleIntervalWidth(DEFAULT_DOUBLE);
    AMPLITUDE_DAO.setAmplitudeType(A5_2);
    AMPLITUDE_DAO.setUnits(DEFAULT_AMPLITUDE_UNITS);
    AMPLITUDE_DAO.setClip(CLIP_FLAG);
    AMPLITUDE_DAO.setInArrival(true);
    AMPLITUDE_DAO.setAuthor(DEFAULT_STRING);
    AMPLITUDE_DAO.setLoadDate(DEFAULT_INSTANT);

    AMPLITUDE_DAO_AMPTYPE_SBSNR = new AmplitudeDao();
    AMPLITUDE_DAO_AMPTYPE_SBSNR.setId(AMPID2);
    AMPLITUDE_DAO_AMPTYPE_SBSNR.setArrivalId(ARID);
    AMPLITUDE_DAO_AMPTYPE_SBSNR.setPredictedArrivalId(ARID);
    AMPLITUDE_DAO_AMPTYPE_SBSNR.setChannelCode(CHAN);
    AMPLITUDE_DAO_AMPTYPE_SBSNR.setAmplitude(432.23);
    AMPLITUDE_DAO_AMPTYPE_SBSNR.setPeriod(DEFAULT_PERIOD);
    AMPLITUDE_DAO_AMPTYPE_SBSNR.setSnr(DEFAULT_DOUBLE);
    AMPLITUDE_DAO_AMPTYPE_SBSNR.setAmplitudeTime(DEFAULT_INSTANT);
    AMPLITUDE_DAO_AMPTYPE_SBSNR.setTime(DEFAULT_INSTANT);
    AMPLITUDE_DAO_AMPTYPE_SBSNR.setDuration(DEFAULT_DURATION);
    AMPLITUDE_DAO_AMPTYPE_SBSNR.setSampleIntervalWidth(DEFAULT_DOUBLE);
    AMPLITUDE_DAO_AMPTYPE_SBSNR.setAmplitudeType(SBSNR);
    AMPLITUDE_DAO_AMPTYPE_SBSNR.setUnits(DEFAULT_AMPLITUDE_UNITS);
    AMPLITUDE_DAO_AMPTYPE_SBSNR.setClip(CLIP_FLAG);
    AMPLITUDE_DAO_AMPTYPE_SBSNR.setInArrival(true);
    AMPLITUDE_DAO_AMPTYPE_SBSNR.setAuthor(DEFAULT_STRING);
    AMPLITUDE_DAO_AMPTYPE_SBSNR.setLoadDate(DEFAULT_INSTANT);
    ...
    ASSOC_TEST_1.setId(
        new AridOridKey.Builder().withOriginId(ORID_1).withArrivalId(ARRIVAL_1.getId()).build());
    ...
    ASSOC_TEST_3.setId(
        new AridOridKey.Builder().withOriginId(ORID_2).withArrivalId(ARRIVAL_3.getId()).build());
  ...
  private static AssocDao getAssocDao(long arid, long orid) {
    ...
    assocDao.setId(new AridOridKey.Builder().withOriginId(orid).withArrivalId(arid).build());
