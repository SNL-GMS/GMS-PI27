...
@AutoValue
public abstract class PhaseMeasurementType
    implements FeatureMeasurementType<PhaseTypeMeasurementValue> {
  ...
  @Override
  public int compareTo(FeatureMeasurementType<PhaseTypeMeasurementValue> phaseMeasurementType) {
    return this.getFeatureMeasurementTypeName()
        .compareTo(phaseMeasurementType.getFeatureMeasurementTypeName());
  }
}
