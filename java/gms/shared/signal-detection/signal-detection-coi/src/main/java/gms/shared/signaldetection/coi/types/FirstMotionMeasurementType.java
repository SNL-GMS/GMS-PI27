...
@AutoValue
public abstract class FirstMotionMeasurementType
    implements FeatureMeasurementType<FirstMotionMeasurementValue> {
  ...
  public int compareTo(
      FeatureMeasurementType<FirstMotionMeasurementValue> firstMotionMeasurementType) {
    return this.getFeatureMeasurementTypeName()
        .compareTo(firstMotionMeasurementType.getFeatureMeasurementTypeName());
  }
}
