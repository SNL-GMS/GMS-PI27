...
@AutoValue
public abstract class DurationMeasurementType
    implements FeatureMeasurementType<DurationMeasurementType> {
  ...
  @Override
  public int compareTo(FeatureMeasurementType<DurationMeasurementType> durationMeasurementType) {
    return this.getFeatureMeasurementTypeName()
        .compareTo(durationMeasurementType.getFeatureMeasurementTypeName());
  }
}
