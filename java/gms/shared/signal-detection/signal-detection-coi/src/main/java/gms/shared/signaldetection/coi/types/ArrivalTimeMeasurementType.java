...
@AutoValue
public abstract class ArrivalTimeMeasurementType
    implements FeatureMeasurementType<ArrivalTimeMeasurementValue> {
  ...
  public int compareTo(
      FeatureMeasurementType<ArrivalTimeMeasurementValue> arrivalTimeMeasurementType) {
    return this.getFeatureMeasurementTypeName()
        .compareTo(arrivalTimeMeasurementType.getFeatureMeasurementTypeName());
  }
}
