...
@AutoValue
public abstract class NumericMeasurementType
    implements FeatureMeasurementType<NumericMeasurementValue> {
  ...
  @Override
  public int compareTo(FeatureMeasurementType<NumericMeasurementValue> numericMeasurementType) {
    return this.getFeatureMeasurementTypeName()
        .compareTo(numericMeasurementType.getFeatureMeasurementTypeName());
  }
}
