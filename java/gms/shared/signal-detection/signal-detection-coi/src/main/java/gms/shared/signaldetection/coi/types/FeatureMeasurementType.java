 ...
 * NOTE: Json Serialization has been customized to produce a single value string for the name. Since
 * deserialization relies on {@link FeatureMeasurementTypes}, custom measurement types will not
 * deserialize properly, as they lack the id info necessary to assume the type.
 *
 * @param <T>
 */

// This is used to deserialize references of FeatureMeasurementType into particular implementing
...
public interface FeatureMeasurementType<T>
    extends Serializable, Comparable<FeatureMeasurementType<T>> {
