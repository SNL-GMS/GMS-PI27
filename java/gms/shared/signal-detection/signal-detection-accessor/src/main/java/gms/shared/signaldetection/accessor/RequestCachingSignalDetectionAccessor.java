...
@Component
@Qualifier("requestCachingSignalDetectionAccessor") public class RequestCachingSignalDetectionAccessor implements SignalDetectionAccessor {
  ...
  public static final String NULL_EXCLUDED_DETECTIONS_MESSAGE =
      "Excluded signal detections cannot be null";
  public static final String EMPTY_STATIONS_MESSAGE =
      "Cannot find signal detections from an empty station list";
  public static final String START_AFTER_END_MESSAGE =
  ...
  public static final String EMPTY_SD_IDS_MESSAGE =
      "Cannot find signal detections from an empty list of IDs";
  public static final String EMPTY_SDH_IDS_MESSAGE =
      "Cannot find signal detection hypotheses from an empty list of IDs";

  private final RequestCache requestCache;
  private final SignalDetectionAccessor delegate;

  public RequestCachingSignalDetectionAccessor(
      @Qualifier("signalDetectionRequestCache") RequestCache requestCache,
      @Qualifier("bridgedSignalDetectionAccessor") SignalDetectionAccessor delegate) {
  ...
  public SignalDetectionsWithChannelSegments findWithSegmentsByIds(
    ...
    if (cachedResult.isEmpty()) {
      SignalDetectionsWithChannelSegments result =
          delegate.findWithSegmentsByIds(signalDetectionIds, stageId);
  ...
  public SignalDetectionsWithChannelSegments findWithSegmentsByStationsAndTime(
    ...
    if (cachedResult.isEmpty()) {
      SignalDetectionsWithChannelSegments result =
          delegate.findWithSegmentsByStationsAndTime(
  ...
  public List<SignalDetection> findByStationsAndTime(
    ...
    return delegate.findByStationsAndTime(
        stations, startTime, endTime, stageId, excludedSignalDetections);
  }
  ...
  public List<SignalDetection> findByStationsAndTime(
    ...
    return delegate.findByStationsAndTime(
        stations, startTime, endTime, stageId, excludedSignalDetections, facetingDefinition);
  }
  ...
  public Mono<Pair<FilterDefinitionByUsageBySignalDetectionHypothesis, Boolean>>
    ...
    return delegate.findFilterDefinitionsForSignalDetections(signalDetections, stageId);
  }
}
