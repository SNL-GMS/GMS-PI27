...
class AmplitudeMeasurementValueConverterTest {
  ...
  void testConvert(
      Optional<AmplitudeMeasurementValue> expectedValue,
  ...
  static Stream<Arguments> getTestConvertArguments() {
    ...
    MeasurementValueSpec<AmplitudeMeasurementValue> measurementValueSpec1 =
    ...
    MeasurementValueSpec<AmplitudeMeasurementValue> measurementValueSpec2 =
        MeasurementValueSpec.<AmplitudeMeasurementValue>builder()
            .setArrivalDao(ARRIVAL_DAO)
    ...
    MeasurementValueSpec<AmplitudeMeasurementValue> measurementValueSpec3 =
        MeasurementValueSpec.<AmplitudeMeasurementValue>builder()
            .setArrivalDao(ARRIVAL_DAO)
    ...
    MeasurementValueSpec<AmplitudeMeasurementValue> measurementValueSpec4 =
        MeasurementValueSpec.<AmplitudeMeasurementValue>builder()
            .setArrivalDao(ARRIVAL_DAO)
    ...
    AmplitudeMeasurementValue ampMeasurementVal =
        AmplitudeMeasurementValue.from(
            AMP_VAL,
            Units.UNITLESS,
            Optional.of(Duration.ofNanos((long) NANO_SEC)),
            Optional.empty(),
            Optional.empty(),
            Optional.empty(),
            Optional.empty());
    ...
    MeasurementValueSpec<AmplitudeMeasurementValue> measurementValueSpec5 =
        MeasurementValueSpec.<AmplitudeMeasurementValue>builder()
            .setArrivalDao(ARRIVAL_DAO)
    ...
    MeasurementValueSpec<AmplitudeMeasurementValue> measurementValueSpec6 =
        MeasurementValueSpec.<AmplitudeMeasurementValue>builder()
            .setArrivalDao(ARRIVAL_DAO)
    ...
    MeasurementValueSpec<AmplitudeMeasurementValue> measurementValueSpec7 =
        MeasurementValueSpec.<AmplitudeMeasurementValue>builder()
            .setArrivalDao(ARRIVAL_DAO)
    ...
    MeasurementValueSpec<AmplitudeMeasurementValue> measurementValueSpec8 =
        MeasurementValueSpec.<AmplitudeMeasurementValue>builder()
            .setArrivalDao(ARRIVAL_DAO)
