...
public class AssocDao {
  ...
  public boolean equals(Object o) {
    ...
    return Double.compare(assocDao.belief, belief) == 0
        ...
        && commentId == assocDao.commentId
        && Objects.equals(id, assocDao.id)
        && Objects.equals(stationCode, assocDao.stationCode)
        && Objects.equals(phase, assocDao.phase)
        && timeDefining == assocDao.timeDefining
        && azimuthDefining == assocDao.azimuthDefining
        && slownessDefining == assocDao.slownessDefining
        && Objects.equals(velocityModel, assocDao.velocityModel)
        && Objects.equals(loadDate, assocDao.loadDate);
  }
  ...
  public int hashCode() {
    return Objects.hash(
        ...
        belief,
        delta,
        stationToEventAzimuth,
        eventToStationAzimuth,
        timeResidual,
        timeDefining,
        azimuthResidual,
        azimuthDefining,
