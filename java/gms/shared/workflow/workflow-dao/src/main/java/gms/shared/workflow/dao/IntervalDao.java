...
public class IntervalDao {
  ...
  private static final int INDEX_OF_FIRST_LETTER_OF_MONTH = 3;
  ...
  public static Instant convertTableDate(String tableData) {
    ...
    formattedString =
        formattedString.replace(
            formattedString.charAt(INDEX_OF_FIRST_LETTER_OF_MONTH),
            Character.toUpperCase(formattedString.charAt(INDEX_OF_FIRST_LETTER_OF_MONTH)));
  ...
  private IntervalDao(Builder builder) {
    ...
    this.classEndTimeNameTimeKey =
        new ClassEndTimeNameTimeKey(builder.type, builder.name, builder.endTime, builder.time);
  ...
  public boolean equals(Object o) {
    ...
    return intervalIdentifier == that.intervalIdentifier
        && Double.compare(that.percentAvailable, percentAvailable) == 0
        && Objects.equals(classEndTimeNameTimeKey, that.classEndTimeNameTimeKey)
        && Objects.equals(state, that.state)
        && Objects.equals(author, that.author)
        && Objects.equals(processStartDate, that.processStartDate)
        && Objects.equals(processEndDate, that.processEndDate)
