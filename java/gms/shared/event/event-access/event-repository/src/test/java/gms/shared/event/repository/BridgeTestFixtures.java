...
public final class BridgeTestFixtures {

  private static final EventBridgeDefinition EVENT_BRIDGE_DEFINITION =
  ...
  public static BridgedEhInformation DEFAULT_BRIDGED_EH_INFORMATION =
      BridgedEhInformation.builder()
          .setEventStages(new EventStages(EVENT_BRIDGE_DEFINITION))
  ...
  public static BridgedSdhInformation DEFAULT_BRIDGED_SDH_INFORMATION =
      BridgedSdhInformation.builder()
          .setSignalDetectionHypothesis(
              SignalDetectionTestFixtures.SIGNAL_DETECTION_HYPOTHESIS_WITH_AMPLITUDE)
  ...
  public static BridgedSdhInformation withIds(
      BridgedSdhInformation sdhInfo, long arrivalId, long originId) {
    ...
    return sdhInfo.toBuilder()
        .setAssocDao(
            AssocDao.Builder.initializeFromInstance(assocDao)
                .withId(
                ...
                .build())
        .setArInfoDao(
            ArInfoDao.Builder.initializeFromInstance(arInfoDao)
        ...
        .setStaMagDaos(
            staMagDaos.stream()
                .map(
                    staMagDao ->
                        StaMagDao.Builder.initializeFromInstance(staMagDao)
                            .withArrivalId(arrivalId)
                            .withOriginId(originId)
                            .build())
                .collect(toSet()))
