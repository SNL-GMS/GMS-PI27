...
public class EventStages {
  ...
  public EventStages(EventBridgeDefinition eventBridgeDefinition) {
    this.orderedStages =
        Objects.requireNonNullElseGet(
            eventBridgeDefinition.getOrderedStages(), Collections::emptyList);
  }
   ...
   * @return {@link WorkflowDefinitionId} of the previous stage or empty {@link Optional} if not
   *     present.
   */
   ...
   *
   * @param stageId reference {@link WorkflowDefinitionId} stage
   * @return {@link WorkflowDefinitionId} of the next stage or empty {@link Optional} if not
   *     present.
   */
  ...
  public String toString() {
    return "EventStages{" + "orderedStages=" + orderedStages + '}';
  }
