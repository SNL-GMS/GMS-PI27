...
class EventBridgeConfigurationTest {
  ...
  void testDefaultEventBridgeDefinition() {
    ...
    var eventBridgeConfiguration =
        new EventBridgeConfiguration(configurationConsumerUtility, systemConfig);
    ...
    var expectedDatabaseAccountsByStage =
        Map.of(
            stageOne,
            "jdbc:stage_one",
            stageTwo,
    ...
    var expectedPreviousDatabaseAccountsByStage =
        Map.of(
            stageTwo, "jdbc:stage_two",
            stageThree, "jdbc:stage_three",
            stageFour, "jdbc:stage_four");

    var expectedEventBridgeDefinition =
    ...
    var resolvedEventBridgeDefinition = eventBridgeConfiguration.currentEventBridgeDefinition();
