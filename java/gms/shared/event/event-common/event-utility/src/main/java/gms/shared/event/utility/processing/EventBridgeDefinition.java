...
public abstract class EventBridgeDefinition {
  ...
  /**
   * Gets the string defining how to assign the monitoringOrganization attribute for bridged Event
   * objects
   *
   * @return A string defining how to assign the monitoringOrganization attribute for bridged Event
   *     objects
   */
   ...
   *
   * @return An ordered list of Stage identifiers corresponding to the Stage ordering in the
   *     Workflow
   */
  ...
  public abstract static class Builder {
     ...
     */
    public abstract Builder setDatabaseUrlByStage(
     ...
     *
     * @param previousDatabaseAccountByStage The EventBridgeDefinition
     *     previousDatabaseAccountByStage value to set
     * @return A Builder with the previousDatabaseAccountByStage EventBridgeDefinition field set
     */
    public abstract Builder setPreviousDatabaseUrlByStage(
        Map<WorkflowDefinitionId, String> previousDatabaseAccountByStage);
