...
class EllipseTest {
  ...
  private static Stream<Arguments> ellipseValidationSource() {
    ...
    return Stream.of(
        ...
        Arguments.arguments(
            SCALING_FACTOR_TYPE, 0.4, K_WEIGHT, DEPTH_UNCERTAINTY, TIME_UNCERTAINTY, true),
        Arguments.arguments(
            SCALING_FACTOR_TYPE, 1.1, K_WEIGHT, DEPTH_UNCERTAINTY, TIME_UNCERTAINTY, true),
        Arguments.arguments(
            SCALING_FACTOR_TYPE, 0.5, K_WEIGHT, DEPTH_UNCERTAINTY, TIME_UNCERTAINTY, false),
        Arguments.arguments(
            SCALING_FACTOR_TYPE, 0.7, K_WEIGHT, DEPTH_UNCERTAINTY, TIME_UNCERTAINTY, false),
        Arguments.arguments(
            SCALING_FACTOR_TYPE, 1.0, K_WEIGHT, DEPTH_UNCERTAINTY, TIME_UNCERTAINTY, false),
        ...
        Arguments.arguments(
            SCALING_FACTOR_TYPE, CONFIDENCE_LEVEL, K_WEIGHT, 0.0, TIME_UNCERTAINTY, false),
        Arguments.arguments(
            SCALING_FACTOR_TYPE, CONFIDENCE_LEVEL, K_WEIGHT, 0.1, TIME_UNCERTAINTY, false),
  ...
  void testSerialization() {
    JsonTestUtilities.assertSerializes(ELLIPSE, Ellipse.class);
  }
}
