...
class FeaturePredictionContainerTest {
  ...
  private static final FeaturePrediction<ArrivalTimeFeaturePredictionValue> fp1b =
      FeaturePrediction.<ArrivalTimeFeaturePredictionValue>builder()
          .setPredictionValue(
              ArrivalTimeFeaturePredictionValue.from(
                  FeatureMeasurementTypes.ARRIVAL_TIME,
  ...
  private static final FeaturePrediction<NumericFeaturePredictionValue> fp2 =
  ...
  void testSerialization() {
    ...
    JsonTestUtilities.assertSerializes(container, FeaturePredictionContainer.class);
  }
  ...
  void testNotEquals() {
    ...
    // Test the class path of equals - container1 is first so that its equals() is used
    Assertions.assertNotEquals(container1, container1.hashCode());

    // Test the null path of equals - container1 is first so that its equals() is used
    container2 = null;
    Assertions.assertNotEquals(container1, container2);
  }
}
