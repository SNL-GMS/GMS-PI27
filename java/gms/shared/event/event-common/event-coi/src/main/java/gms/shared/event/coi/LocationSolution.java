...
/**
 * Define a LocationSolution class for process results. Describes an estimate of where an {@link
 * EventHypothesis} may be located, as well as additional location dependent information
 */
@AutoValue
...
public abstract class LocationSolution {
  ...
  public abstract static class Data {
    ...
    public abstract static class Builder {
      ...
      public abstract LocationSolution.Data.Builder setLocationRestraint(
      ...
      public abstract LocationSolution.Data.Builder setLocationUncertainty(
      ...
      abstract LocationSolution.Data.Builder setLocationBehaviors(
          ImmutableSet<LocationBehavior> locationBehaviors);

      public LocationSolution.Data.Builder setLocationBehaviors(
      ...
      /**
       * Returns a LocationSolution.Data object only if all the fields are properly set. This
       * intentionally returns null if the Location and LocationRestraint are not set. This is to
       * support deserialization of a faceted Location Solution using Jackson.
       *
       * @return LocationSolution.Data
       */
      @Nullable public LocationSolution.Data build() {
        ...
        var data = autoBuild();
        var errorMessage =
            "Each location behavior's feature prediction must exist in the location solution's set"
                + " of feature predictions";
                ...
                behavior ->
                    behavior
                        ...
                        .ifPresent(
                            fp ->
                                checkState(
                                    data.getFeaturePredictions().contains(fp), errorMessage)));
        return data;
      }
    }
  }
