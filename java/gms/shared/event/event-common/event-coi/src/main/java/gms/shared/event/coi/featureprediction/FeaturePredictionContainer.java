 ...
 * of a collection of different FeaturePredictions, to avoid using wild cards in public method
 * return types.
 */
public final class FeaturePredictionContainer {

  private final Multimap<FeaturePredictionType<?>, FeaturePrediction<?>>
      featureMeasurementTypeFeaturePredictionMap;

  private FeaturePredictionContainer(
      Multimap<FeaturePredictionType<?>, FeaturePrediction<?>>
          featureMeasurementTypeFeaturePredictionMap) {
  ...
  public static FeaturePredictionContainer create(
      @JsonProperty("featurePredictions")
          Collection<FeaturePrediction<? extends FeaturePredictionValue<?, ?, ?>>>
              featurePredictions) {
    // create immutable multimap from the list of feature predictions
    Multimap<FeaturePredictionType<?>, FeaturePrediction<?>> immutableMap =
        Multimaps.index(featurePredictions, FeaturePrediction::getPredictionType);

    return new FeaturePredictionContainer(immutableMap);
  }
   ...
   */
  @JsonIgnore
  public <T extends FeaturePredictionValue<?, ?, ?>>
      Set<FeaturePrediction<T>> getFeaturePredictionsForType(
          FeaturePredictionType<T> featurePredictionType) {

    //
    // We need to cast element-wise in the returned collection, because
    // (Set<FeaturePrediction<T>>)
    // featureMeasurementTypeFeaturePredictionMap.get(featurePredictionType)
    // will not work.
    //
    return featureMeasurementTypeFeaturePredictionMap.get(featurePredictionType).stream()
        ...
        // does not work, because type erasure removes the type T from the casted object. So, a
        // separate
   ...
   * @return True if the container has the prediction, false otherwise.
   */
  ...
  /**
   * Get the collection of all of our FeaturePredictions. This is used soley for Jackson to
   * serialize, and should remain private.
   *
