...
@JsonTypeInfo(
    ...
    property = "correctionType")
@JsonSubTypes({
  @JsonSubTypes.Type(value = ElevationCorrectionDefinition.class, name = "ELEVATION_CORRECTION"),
  @JsonSubTypes.Type(
      value = EllipticityCorrectionDefinition.class,
      name = "ELLIPTICITY_CORRECTION"),
  @JsonSubTypes.Type(
      value = MasterEventCorrectionDefinition.class,
      name = "MASTER_EVENT_CORRECTION")
})
