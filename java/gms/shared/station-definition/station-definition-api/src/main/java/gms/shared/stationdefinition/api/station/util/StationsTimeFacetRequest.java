...
/** A {@link Request} for faceted {@link Station}s by time from the station definition endpoint */
@AutoValue
...
public abstract class StationsTimeFacetRequest implements Request {
  ...
  public interface Builder {
    ...
    StationsTimeFacetRequest.Builder setFacetingDefinition(
    ...
    default StationsTimeFacetRequest.Builder setFacetingDefinition(
    ...
    default StationsTimeFacetRequest build() {
      var stationsTimeFacetRequest = autoBuild();
      Validate.notEmpty(
          stationsTimeFacetRequest.getStationNames(),
          "Stations time facet request must be provided a list of station names");
      stationsTimeFacetRequest
          .getEffectiveTime()
          .ifPresent(
              data ->
                  Preconditions.checkState(
                      stationsTimeFacetRequest.getEffectiveTime().isPresent()));
      stationsTimeFacetRequest
          .getFacetingDefinition()
          .ifPresent(
              data ->
                  Preconditions.checkState(
                      stationsTimeFacetRequest.getFacetingDefinition().isPresent()));
