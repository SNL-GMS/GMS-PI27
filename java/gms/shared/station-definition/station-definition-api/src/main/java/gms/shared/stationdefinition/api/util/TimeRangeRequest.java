...
/** A {@link Request} for a time range from the station definition endpoint */
@AutoValue
...
public abstract class TimeRangeRequest {
  ...
  public interface Builder {
    ...
    default TimeRangeRequest build() {
      final var timeRangeRequest = autoBuild();
      Preconditions.checkArgument(
          !timeRangeRequest.getStartTime().isAfter(timeRangeRequest.getEndTime()),
