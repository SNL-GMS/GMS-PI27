...
/** A {@link Request} for {@link Channel}s by time from the station definition endpoint */
@AutoValue
...
public abstract class ChannelsTimeRequest implements Request {
  ...
  public interface Builder {
    ...
    ChannelsTimeRequest.Builder setEffectiveTime(Optional<Instant> effectiveTime);

    default ChannelsTimeRequest.Builder setEffectiveTime(Instant effectiveTime) {
