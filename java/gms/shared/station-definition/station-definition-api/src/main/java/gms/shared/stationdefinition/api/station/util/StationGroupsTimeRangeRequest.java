...
/**
 * A {@link Request} for {@link StationGroup}s by time range from the station definition endpoint
 */
@AutoValue
...
public abstract class StationGroupsTimeRangeRequest implements Request {
  ...
  public interface Builder {
    ...
    StationGroupsTimeRangeRequest.Builder setStationGroupNames(
        ImmutableList<String> stationGroupNames);

    default StationGroupsTimeRangeRequest.Builder setStationGroupNames(
