...
/** A {@link Request} for {@link StationGroup}s by time from the station definition endpoint */
@AutoValue
...
public abstract class StationGroupsTimeRequest implements Request {
  ...
  public interface Builder {
    ...
    default StationGroupsTimeRequest.Builder setStationGroupNames(
    ...
    StationGroupsTimeRequest.Builder setEffectiveTime(Optional<Instant> effectiveTime);

    default StationGroupsTimeRequest.Builder setEffectiveTime(Instant effectiveTime) {
