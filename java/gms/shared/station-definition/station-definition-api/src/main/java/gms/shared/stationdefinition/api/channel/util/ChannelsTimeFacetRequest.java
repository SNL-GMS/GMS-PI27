...
/** A {@link Request} for faceted {@link Channel}s by time from the station definition endpoint */
@AutoValue
...
public abstract class ChannelsTimeFacetRequest implements Request {
  ...
  public abstract static class Builder {
    ...
    public abstract ChannelsTimeFacetRequest.Builder setChannelNames(
        ImmutableList<String> channelNames);
    ...
    public abstract ChannelsTimeFacetRequest.Builder setEffectiveTime(
        Optional<Instant> effectiveTime);

    public ChannelsTimeFacetRequest.Builder setFacetingDefinition(
