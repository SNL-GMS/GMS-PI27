...
/**
 * A {@link Request} for {@link ChannelGroup}s by time range from the station definition endpoint
 */
@AutoValue
...
public abstract class ChannelGroupsTimeRangeRequest implements Request {
  ...
  public interface Builder {
    ...
    ChannelGroupsTimeRangeRequest.Builder setChannelGroupNames(
        ImmutableList<String> channelGroupNames);

    default ChannelGroupsTimeRangeRequest.Builder setChannelGroupNames(
