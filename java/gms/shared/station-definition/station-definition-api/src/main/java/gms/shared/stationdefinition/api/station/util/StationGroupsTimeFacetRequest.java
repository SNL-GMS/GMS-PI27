...
/**
 * A {@link Request} for faceted {@link StationGroup}s by time from the station definition endpoint
 */
@AutoValue
...
public abstract class StationGroupsTimeFacetRequest implements Request {
  ...
  public interface Builder {
    ...
    StationGroupsTimeFacetRequest.Builder setStationGroupNames(
        ImmutableList<String> stationGroupNames);

    default StationGroupsTimeFacetRequest.Builder setStationGroupNames(
    ...
    StationGroupsTimeFacetRequest.Builder setFacetingDefinition(
    ...
    default StationGroupsTimeFacetRequest.Builder setFacetingDefinition(
    ...
    default StationGroupsTimeFacetRequest build() {
      var stationGroupsTimeFacetRequest = autoBuild();
      Validate.notEmpty(
          stationGroupsTimeFacetRequest.getStationGroupNames(),
          "Station groups time facet request must be provided a list of station group names");
      stationGroupsTimeFacetRequest
          .getEffectiveTime()
          .ifPresent(
              data ->
                  Preconditions.checkState(
                      stationGroupsTimeFacetRequest.getEffectiveTime().isPresent()));
      stationGroupsTimeFacetRequest
          .getFacetingDefinition()
          .ifPresent(
              data ->
                  Preconditions.checkState(
                      stationGroupsTimeFacetRequest.getFacetingDefinition().isPresent()));
