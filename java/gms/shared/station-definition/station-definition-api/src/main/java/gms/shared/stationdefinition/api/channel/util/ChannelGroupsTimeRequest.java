...
/** A {@link Request} for {@link ChannelGroup}s by time from the station definition endpoint */
@AutoValue
...
public abstract class ChannelGroupsTimeRequest implements Request {
  ...
  public interface Builder {
    ...
    default ChannelGroupsTimeRequest.Builder setChannelGroupNames(
    ...
    ChannelGroupsTimeRequest.Builder setEffectiveTime(Optional<Instant> effectiveTime);

    default ChannelGroupsTimeRequest.Builder setEffectiveTime(Instant effectiveTime) {
