...
import gms.shared.stationdefinition.configuration.PhaseTypesByBeamDescriptions;
...
import gms.shared.stationdefinition.testfixtures.CssDaoAndCoiParameters.SITE_ARGS;
...
public final class CSSDaoTestFixtures {
  ...
  /**
   * Information from SITE_DAO_1, SITE_CHAN_DAO_1, SENSOR_DAO_1, and INSTRUMENT DAO_1 will be used
   * to create Channel_1. Information from SITE_DAO_1, SITE_CHAN_DAO_2, SENSOR_DAO_2, and INSTRUMENT
   * DAO_2 will be used to create Channel_1. Information from SITE_DAO_2, SITE_CHAN_DAO_3,
   * SENSOR_DAO_3, and INSTRUMENT DAO_3 will be used to create Channel_1.
   *
   * <p>Channel_1 and Channel_2 belong to the same ChannelGroup, Channel_3 is a separate
   * ChannelGroup.
   *
   * <p>SITE_DAO_1, SITE_DAO_2, and SITE_DAO_3 along with all the other information will be used to
   * create a station with the channel groups and channels above.
   */
  static {
    ...
    // affilliation 2
    NETWORK_DAO_1 =
        createNetworkDao(1, NETWORK_NAME_1, NETWORK_DESC_1, ONDATE, OFFDATE, AUTHOR1, LDATE);
    NETWORK_DAO_1_NO_OFFDATE =
        createNetworkDao(1, NETWORK_NAME_1, NETWORK_DESC_1, ONDATE, null, AUTHOR1, LDATE);
    NETWORK_DAO_1_1 =
        createNetworkDao(
            2, NETWORK_NAME_1, NETWORK_DESC_1, ONDATE, OFFDATE, AUTHOR1, LDATE.plusSeconds(30000));
    NETWORK_DAO_2 =
        createNetworkDao(
            3, NETWORK_NAME_2, NETWORK_DESC_2, ONDATE, OFFDATE, "pers2", LDATE.plusSeconds(30000));
    NETWORK_DAO_3 =
        createNetworkDao(
            NETWORK_ID_10, NETWORK_NAME_1, NETWORK_DESC_1, ONDATE6, OFFDATE6, AUTHOR1, LDATE);
    NETWORK_DAO_4 =
        createNetworkDao(
            NETWORK_ID_15, NETWORK_NAME_1, NETWORK_DESC_2, OFFDATE6, null, AUTHOR1, LDATE);
    NETWORK_DAO_5 =
        createNetworkDao(
            NETWORK_ID_11, NETWORK_NAME_1, NETWORK_DESC_2, ONDATE7, null, AUTHOR1, LDATE);
    NETWORK_DAO_6 =
        createNetworkDao(
            NETWORK_ID_12, NETWORK_NAME_1, NETWORK_DESC_1, ONDATE8, ONDATE3, AUTHOR1, LDATE);
    NETWORK_DAO_7 =
        createNetworkDao(
            NETWORK_ID_31, NETWORK_NAME_1, NETWORK_DESC_3, ONDATE3, null, AUTHOR1, LDATE);
    NETWORK_DAO_8 =
        createNetworkDao(
            NETWORK_ID_32, NETWORK_NAME_1, NETWORK_DESC_4, ONDATE9, null, AUTHOR1, LDATE);
    NETWORK_DAO_9 =
        createNetworkDao(
            NETWORK_ID_33, NETWORK_NAME_1, NETWORK_DESC_2, ONDATE8, null, AUTHOR1, LDATE);
    NETWORK_DAO_10 =
        createNetworkDao(NETWORK_ID_33, NETWORK_NAME_1, NETWORK_DESC_2, null, null, AUTHOR1, LDATE);
    ...
    AFFILIATION_DAO_SAME_START1 =
        createAffiliationDao(NETWORK_NAME_1, REFERENCE_STATION_2, OFFDATE);
    ...
    SITE_CHAN_DAO_REF_11 =
        createSiteChanDao(STA1, CHAN1, ONDATE, OFFDATE, CHAN_PARAM_MAP, CHANID_1);
    SITE_CHAN_DAO_REF_13 =
        createSiteChanDao(STA3, CHAN3, ONDATE, OFFDATE, CHAN_PARAM_MAP, CHANID_3);
    SITE_CHAN_DAO_REF_14 =
        createSiteChanDao(STA4, CHAN4, ONDATE, OFFDATE, CHAN_PARAM_MAP, CHANID_4);

    // sitechan daos for reference 2
    SITE_CHAN_DAO_REF_21 =
        createSiteChanDao(STAXX1, CHAN1, ONDATE2, OFFDATE2, CHAN_PARAM_MAP, CHANID_1);
    SITE_CHAN_DAO_REF_22 =
        createSiteChanDao(STAXX2, CHAN2, ONDATE2, OFFDATE2, CHAN_PARAM_MAP, CHANID_2);

    // sitechan daos for reference 3
    SITE_CHAN_DAO_REF_31 =
        createSiteChanDao(STAYY1, CHAN2, ONDATE2, OFFDATE2, CHAN_PARAM_MAP, CHANID_2);
    SITE_CHAN_DAO_REF_32 =
        createSiteChanDao(STAYY2, CHAN3, ONDATE2, OFFDATE2, CHAN_PARAM_MAP, CHANID_3);
    SITE_CHAN_DAO_REF_33 =
        createSiteChanDao(STAYY3, CHAN4, ONDATE2, OFFDATE2, CHAN_PARAM_MAP, CHANID_4);

    // sitechan daos for reference 4
    SITE_CHAN_DAO_REF_41 =
        createSiteChanDao(STAWW1, CHAN3, ONDATE3, OFFDATE3, CHAN_PARAM_MAP, CHANID_3);
    SITE_CHAN_DAO_REF_42 =
        createSiteChanDao(STAWW2, CHAN4, ONDATE3, OFFDATE3, CHAN_PARAM_MAP, CHANID_4);

    INSTRUMENT_DAO_1 =
        createInstrumentDao(INSTID_1, CssDaoAndCoiParameters.INSTRUMENT_PARAM_MAP, LDATE);
    INSTRUMENT_DAO_1_1 =
        createInstrumentDao(
            INSTID_1, CssDaoAndCoiParameters.INSTRUMENT_PARAM_MAP, LDATE.plusSeconds(30000));
    INSTRUMENT_DAO_2 =
        createInstrumentDao(INSTID_2, CssDaoAndCoiParameters.INSTRUMENT_PARAM_MAP_2, LDATE);
    INSTRUMENT_DAO_3 =
        createInstrumentDao(INSTID_3, CssDaoAndCoiParameters.INSTRUMENT_PARAM_MAP, LDATE);
    UNRELATED_INSTRUMENT_DAO =
        createInstrumentDao(
            CssDaoAndCoiParameters.UN_INSTID, CssDaoAndCoiParameters.INSTRUMENT_PARAM_MAP, LDATE);

    // sensor daos for for site chans
    SENSOR_DAO_REF_11 =
        createSensorDao(STA1, CHAN1, CHANID_1, INSTRUMENT_DAO_1, SENSOR_PARAM_MAP, ONDATE, OFFDATE);
    SENSOR_DAO_REF_12 =
        createSensorDao(STA2, CHAN2, CHANID_2, INSTRUMENT_DAO_2, SENSOR_PARAM_MAP, ONDATE, OFFDATE);
    SENSOR_DAO_REF_13 =
        createSensorDao(STA3, CHAN3, CHANID_3, INSTRUMENT_DAO_3, SENSOR_PARAM_MAP, ONDATE, OFFDATE);
    SENSOR_DAO_REF_14 =
        createSensorDao(STA4, CHAN4, CHANID_4, INSTRUMENT_DAO_1, SENSOR_PARAM_MAP, ONDATE, OFFDATE);
    SENSOR_DAO_REF_21 =
        createSensorDao(
            STAXX1, CHAN1, CHANID_1, INSTRUMENT_DAO_1, SENSOR_PARAM_MAP, ONDATE2, OFFDATE2);
    SENSOR_DAO_REF_22 =
        createSensorDao(
            STAXX2, CHAN2, CHANID_2, INSTRUMENT_DAO_2, SENSOR_PARAM_MAP, ONDATE2, OFFDATE2);
    SENSOR_DAO_REF_31 =
        createSensorDao(
            STAYY1, CHAN1, CHANID_1, INSTRUMENT_DAO_1, SENSOR_PARAM_MAP, ONDATE2, OFFDATE2);
    SENSOR_DAO_REF_32 =
        createSensorDao(
            STAYY2, CHAN2, CHANID_2, INSTRUMENT_DAO_2, SENSOR_PARAM_MAP, ONDATE2, OFFDATE2);
    SENSOR_DAO_REF_33 =
        createSensorDao(
            STAYY3, CHAN3, CHANID_3, INSTRUMENT_DAO_3, SENSOR_PARAM_MAP, ONDATE2, OFFDATE2);
    SENSOR_DAO_REF_41 =
        createSensorDao(
            STAWW1, CHAN1, CHANID_1, INSTRUMENT_DAO_1, SENSOR_PARAM_MAP, ONDATE3, OFFDATE3);
    SENSOR_DAO_REF_42 =
        createSensorDao(
            STAWW2, CHAN2, CHANID_2, INSTRUMENT_DAO_2, SENSOR_PARAM_MAP, ONDATE3, OFFDATE3);
    ...
    SITE_CHAN_DAO_NA_ENDTIME =
        createSiteChanDao(STA1, CHAN1, ONDATE, OFFDATE_NA, CHAN_PARAM_MAP, CHANID_1);
    ...
    SITE_CHAN_DAO_1_1 =
        createSiteChanDao(
            STA1, CHAN1, ONDATE.plusSeconds(30000), OFFDATE, CHAN_PARAM_MAP, CHANID_1);
    ...
    SINGLE_SITE_CHAN =
        createSiteChanDao(REFERENCE_STATION, CHAN1, ONDATE, OFFDATE, CHAN_PARAM_MAP, CHANID_1);

    UNRELATED_SITE_CHAN_DAO =
        createSiteChanDao(UN_STA, CHAN2, OFFDATE, ONDATE, CHAN_PARAM_MAP, CHANID_3);

    SITE_CHAN_2_LETTER_CHANNEL =
        createSiteChanDao(STA1, "bz", ONDATE, OFFDATE, CHAN_PARAM_MAP, CHANID_1);

    SITE_CHAN_STA_1_DAO_TIME_1 =
        createSiteChanDao(
            STA1,
            CHAN1,
            ONDATE.minusSeconds(400000),
            OFFDATE.minusSeconds(80000),
            CHAN_PARAM_MAP,
            CHANID_1);
    SITE_CHAN_STA_1_DAO_TIME_2 =
        createSiteChanDao(
            STA1,
            CHAN2,
            ONDATE.plusSeconds(30000),
            OFFDATE.minusSeconds(300000),
            CHAN_PARAM_MAP,
            CHANID_2);
    SITE_CHAN_STA_1_DAO_TIME_3 =
        createSiteChanDao(
            STA1,
            CHAN3,
            OFFDATE.minusSeconds(400000),
            OFFDATE.plusSeconds(200000),
            CHAN_PARAM_MAP,
            CHANID_4);
    SITE_CHAN_STA_1_DAO_TIME_4 =
        createSiteChanDao(
            STA1,
            CHAN4,
            ONDATE.plusSeconds(30000),
    ...
    SITE_CHAN_ANOTHER_STA =
        createSiteChanDao(ANOTHER_STA, CHAN3, ONDATE, OFFDATE, CHAN_PARAM_MAP, CHANID_5);

    SENSOR_DAO_1 =
        createSensorDao(
            STA1, CHAN1, CHANID_1, INSTRUMENT_DAO_1, SENSOR_PARAM_MAP, START_TIME, END_TIME);
    SENSOR_DAO_1_1 =
        createSensorDao(
            STA1,
            CHAN1,
    ...
    SENSOR_DAO_1_2 =
        createSensorDao(
            ...
            START_TIME.plusSeconds(30000));
    SENSOR_DAO_1_3 =
        createSensorDao(STA1, CHAN1, CHANID_1, INSTRUMENT_DAO_2, SENSOR_PARAM_MAP, ONDATE, OFFDATE);
    SENSOR_DAO_2 =
        createSensorDao(
            STA1, CHAN2, CHANID_2, INSTRUMENT_DAO_2, SENSOR_PARAM_MAP, ONDATE, END_TIME);
    SENSOR_DAO_4 =
        createSensorDao(
            STA1, CHAN3, CHANID_4, INSTRUMENT_DAO_1, SENSOR_PARAM_MAP, START_TIME, END_TIME);
    SENSOR_DAO_6 =
        createSensorDao(
            STA1, CHAN4, CHANID_6, INSTRUMENT_DAO_3, SENSOR_PARAM_MAP, START_TIME, END_TIME);
    SENSOR_DAO_3 =
        createSensorDao(
            STA2, CHAN3, CHANID_3, INSTRUMENT_DAO_3, SENSOR_PARAM_MAP, START_TIME, END_TIME);
    SENSOR_DAO_5 =
        createSensorDao(
            ANOTHER_STA, CHAN1, CHANID_5, INSTRUMENT_DAO_3, SENSOR_PARAM_MAP, START_TIME, END_TIME);
    SENSOR_DAO_7 =
        createSensorDao(
            STA1, CHAN1, CHANID_1, INSTRUMENT_DAO_1, SENSOR_PARAM_MAP, ONDATE2, ONDATE4);
    SENSOR_DAO_8 =
        createSensorDao(
            STA1, CHAN1, CHANID_1, INSTRUMENT_DAO_2, SENSOR_PARAM_MAP, ONDATE3, OFFDATE);

    UNRELATED_SENSOR_DAO =
        createSensorDao(
            STA2,
            CHAN3,
            CssDaoAndCoiParameters.UN_CHANID,
            INSTRUMENT_DAO_3,
            SENSOR_PARAM_MAP,
            START_TIME,
            END_TIME);
    ...
    WFDISC_DAO_END_TIME =
        createWfdiscDao(WFID_1, CHANID_1, ONDATE.plusSeconds(10), WFDISC_PARAM_MAP);

    WFDISC_TEST_DAO_1 =
        createWfdiscDao(STA1, CHAN1, ONDATE, END_TIME, WFID_1, CHANID_1, WFDISC_PARAM_MAP);
    WFDISC_TEST_DAO_2 =
        createWfdiscDao(STA1, CHAN2, ONDATE, END_TIME, WFID_2, CHANID_2, WFDISC_PARAM_MAP);
    WFDISC_TEST_DAO_3 =
        createWfdiscDao(STA2, CHAN3, ONDATE, END_TIME, WFID_3, CHANID_3, WFDISC_PARAM_MAP);
    WFDISC_TEST_DAO_4 =
        createWfdiscDao(STA1, CHAN1, ONDATE2, ONDATE3, WFID_3, CHANID_3, WFDISC_PARAM_MAP);
    WFDISC_TEST_DAO_5 =
        createWfdiscDao(STA1, CHAN1, ONDATE, ONDATE2, WFID_1, CHANID_1, WFDISC_PARAM_MAP);
    WFDISC_TEST_DAO_6 =
        createWfdiscDao(STA1, CHAN1, ONDATE2, ONDATE3, WFID_1, CHANID_1, WFDISC_PARAM_MAP);
    WFDISC_TEST_DAO_7 =
        createWfdiscDao(STA1, CHAN1, ONDATE3, OFFDATE4, WFID_1, CHANID_1, WFDISC_PARAM_MAP);
    WFDISC_TEST_DAO_8 =
        createWfdiscDao(STA2, CHAN2, ONDATE, END_TIME, WFID_2, CHANID_2, WFDISC_PARAM_MAP);
    ...
    INTERVAL_DAO_NET_NETS1_DONE =
        new IntervalDao.Builder()
  ...
  public static SiteChanDao createSiteChanDao(
      String siteName,
      String channelName,
      Instant onDate,
      Instant offDate,
      Map<SITE_CHAN_ARGS, Double> argMap,
      int chanId) {
    var siteChanDao = new SiteChanDao();
    var siteChanKey = new SiteChanKey();
  ...
  public static SensorDao createSensorDao(
      ...
      Map<CssDaoAndCoiParameters.SENSOR_ARGS, Double> argMap,
      Instant onDate,
      Instant offDate) {

    var sensorDao = new SensorDao();
    var sensorKey = new SensorKey();
  ...
  protected static InstrumentDao createInstrumentDao(
      long inid, Map<CssDaoAndCoiParameters.INSTRUMENT_ARGS, Double> argMap, Instant ldate) {
    ...
    instrumentDao.setNominalCalibrationPeriod(
        argMap.get(CssDaoAndCoiParameters.INSTRUMENT_ARGS.CALIBRATIO));
  ...
  private static AffiliationDao createAffiliationDao(
      String networkName, String station, Instant onDate) {
    var affiliationDao = new AffiliationDao();
    final var networkStationTimeKey = new NetworkStationTimeKey();
  ...
  private static NetworkDao createNetworkDao(
      long networkId,
      String networkName,
      String description,
      Instant onDate,
  ...
  public static WfdiscDao createWfdiscDao(long wfid, long chanid, Map<WFDISC_ARGS, Number> argMap) {
    return createWfdiscDao(STA1, CHAN1, ONDATE, END_TIME, wfid, chanid, argMap);
  }

  public static WfdiscDao createWfdiscDao(
      long wfid, long chanid, Instant endTime, Map<WFDISC_ARGS, Number> argMap) {
  ...
  public static void addArrivalWftagAndBeamDaos(
      List<WfdiscDao> wfdiscDaos,
      List<ArrivalDao> arrivalDaos,
      List<WfTagDao> wfTagDaos,
      List<WfTagDao> originalWfTagDaos,
      List<BeamDao> beamDaos) {

    var arid = 0;

    for (var wfdiscDao : wfdiscDaos) {
      arrivalDaos.add(
          createArrivalDao(
              wfdiscDao.getStationCode(), wfdiscDao.getChannelCode(), wfdiscDao.getTime(), arid));
  ...
  private static ArrivalDao createArrivalDao(String sta, String chan, Instant onDate, long arid) {
    ...
    var arrivalKey = new StationChannelTimeKey();
  ...
  private static FrequencyAmplitudePhase createFAP() {
    ...
    double[] phases = {-1.786542, -1.791653};
  ...
  public static List<SiteAndSurroundingDates> getTestSiteAndSurroundingDates() {
    return List.of(
        new SiteAndSurroundingDates(new SiteDao(SITE_DAO_1), SITE_DAO_1.getId().getOnDate(), null),
  ...
  public static List<SiteChanAndSurroundingDates> getTestSiteChanAndSurroundingDates() {
    return List.of(
        new SiteChanAndSurroundingDates(
            new SiteChanDao(SITE_CHAN_DAO_1), SITE_CHAN_DAO_1.getId().getOnDate(), null),
        new SiteChanAndSurroundingDates(
            new SiteChanDao(SITE_CHAN_DAO_2), null, SITE_CHAN_DAO_2.getOffDate()),
            ...
            dao ->
                Channel.builder()
                    .setName(
                        STA
                            + "."
                            + dao.getId().getStationCode()
                            + "."
                            + dao.getId().getChannelCode())
                    .setEffectiveAt(ONDATE)
                    .build())
        .collect(Collectors.toList());
  }

  public static PhaseTypesByBeamDescriptions getTestBeamPhase() {
    Map<String, PhaseType> inputMap = new HashMap<>();
    inputMap.put("szb", PhaseType.P);

    return PhaseTypesByBeamDescriptions.from(inputMap);
  }
  ...
  public static List<SiteDao> getTestSiteDaosForBridged() {
    List<SiteDao> siteDaosRef1 =
        List.of(SITE_DAO_REF_1, SITE_DAO_REF_11, SITE_DAO_REF_12, SITE_DAO_REF_13, SITE_DAO_REF_14);
    List<SiteDao> siteDaosRef2 = List.of(SITE_DAO_REF_2, SITE_DAO_REF_21, SITE_DAO_REF_22);
    List<SiteDao> siteDaosRef3 =
        List.of(SITE_DAO_REF_3, SITE_DAO_REF_31, SITE_DAO_REF_32, SITE_DAO_REF_33);
