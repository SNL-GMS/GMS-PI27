...
public final class CssDaoAndCoiParameters {
  ...
  public static final Instant OFFDATE_EOD = Instant.parse("2020-04-01T23:59:59.999Z");
  ...
  public static final Instant MIN_START_TIME = Instant.parse("2000-03-31T23:59:59Z");
  public static final Instant MAX_END_TIME = Instant.parse("2020-04-01T00:00:01Z");
  ...
  public static final Map<SITE_ARGS, Double> STA1_PARAM_MAP =
      Map.ofEntries(
          Map.entry(SITE_ARGS.LATITUDE, LATITUDE1),
          Map.entry(SITE_ARGS.LONGITUDE, LONGITUDE1),
          Map.entry(SITE_ARGS.ELEVATION, ELEVATION1),
          Map.entry(SITE_ARGS.DEAST, -3.649),
          Map.entry(SITE_ARGS.DNORTH, 0.770));
  public static final Map<SITE_ARGS, Double> STA2_PARAM_MAP =
      Map.ofEntries(
          Map.entry(SITE_ARGS.LATITUDE, 52.72137),
          Map.entry(SITE_ARGS.LONGITUDE, 76.20036),
          Map.entry(SITE_ARGS.ELEVATION, 0.620),
          Map.entry(SITE_ARGS.DEAST, -2.700),
          Map.entry(SITE_ARGS.DNORTH, 0.771));
  public static final Map<SITE_ARGS, Double> STA3_PARAM_MAP =
      Map.ofEntries(
          Map.entry(SITE_ARGS.LATITUDE, 52.42311),
          Map.entry(SITE_ARGS.LONGITUDE, 76.12066),
          Map.entry(SITE_ARGS.ELEVATION, 0.621),
          Map.entry(SITE_ARGS.DEAST, 0.0),
          Map.entry(SITE_ARGS.DNORTH, 0.0));

  public static final Map<SITE_CHAN_ARGS, Double> CHAN_PARAM_MAP =
      Map.ofEntries(
          Map.entry(SITE_CHAN_ARGS.EMPLACEMENT, 0.03),
          Map.entry(SITE_CHAN_ARGS.HORIZONTAL, -1.0),
          Map.entry(SITE_CHAN_ARGS.VERTICAL, 0.0));

  public static final Map<SENSOR_ARGS, Double> SENSOR_PARAM_MAP =
      Map.ofEntries(
          Map.entry(SENSOR_ARGS.CALIBRATION, 1.0),
          Map.entry(SENSOR_ARGS.CALIBPER, 1.0),
          Map.entry(SENSOR_ARGS.SHIFT, 0.0));
  public static final Map<SENSOR_ARGS, Double> SENSOR_PARAM_MAP_2 =
      Map.ofEntries(
          Map.entry(SENSOR_ARGS.CALIBRATION, 1.0),
          Map.entry(SENSOR_ARGS.CALIBPER, 1.0),
          Map.entry(SENSOR_ARGS.SHIFT, 1.0));

  public static final Map<INSTRUMENT_ARGS, Double> INSTRUMENT_PARAM_MAP =
      Map.ofEntries(
          Map.entry(INSTRUMENT_ARGS.CALIBFACTOR, 0.061607),
          Map.entry(INSTRUMENT_ARGS.CALIBRATIO, 1.0),
          Map.entry(INSTRUMENT_ARGS.SAMPLERATE, 40.0));

  public static final Map<INSTRUMENT_ARGS, Double> INSTRUMENT_PARAM_MAP_2 =
      Map.ofEntries(
          Map.entry(INSTRUMENT_ARGS.CALIBFACTOR, 0.061607),
          Map.entry(INSTRUMENT_ARGS.CALIBRATIO, 1.0),
          Map.entry(INSTRUMENT_ARGS.SAMPLERATE, 50.0));

  public static final Map<WFDISC_ARGS, Number> WFDISC_PARAM_MAP =
      Map.ofEntries(
  ...
  public static final Map<WFDISC_ARGS, Number> WFDISC_PARAM_MAP_2 =
      Map.ofEntries(
