...
public final class StationDefinitionCoiUtils {

  public static final Comparator<StationGroup> STATION_GROUP_COMPARATOR =
      new StationGroupComparator();
  public static final Comparator<Station> STATION_COMPARATOR = new StationComparator();
  public static final Comparator<ChannelGroup> CHANNEL_GROUP_COMPARATOR =
      new ChannelGroupComparator();
  ...
  public static final Comparator<FrequencyAmplitudePhase> FREQUENCY_AMPLITUDE_PHASE_COMPARATOR =
      new FrequencyAmplitudePhaseComparator();
