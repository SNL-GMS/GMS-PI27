...
@ControllerAdvice
class SignalEnhancementConfigurationControllerEventHandler {

  private static final Logger LOGGER =
      LoggerFactory.getLogger(SignalEnhancementConfigurationControllerEventHandler.class);

  private static final String BASE_ERROR_MSG = "Exception occurred view stacktrace for details";
  ...
  @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
  public ResponseEntity<Map<String, String>> handle(FileNotFoundException ex) {
    LOGGER.warn(BASE_ERROR_MSG, ex);
    return constructGeneralError();
  }
