...
public abstract class FilterListDefinition {
  ...
  public static FilterListDefinition from(
      @JsonProperty("preferredFilterListByActivity")
          Collection<WorkflowDefinitionIdStringPair> preferredFilterListByActivity,
      @JsonProperty("filterLists") Collection<FilterList> filterLists) {

    return new AutoValue_FilterListDefinition(
        ImmutableList.copyOf(preferredFilterListByActivity), ImmutableList.copyOf(filterLists));
  }
}
