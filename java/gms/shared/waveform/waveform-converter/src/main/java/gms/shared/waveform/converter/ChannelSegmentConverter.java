...
public interface ChannelSegmentConverter {
  ...
  /**
   * Converts a channel, list of {@link WfdiscDao} and a list of files for those wfdisc daos into a
   * ChannelSegment
   *
   ...
   */
  ChannelSegment<Waveform> convert(
      Channel channel, List<WfdiscDao> wfDiscDaos, Instant startTime, Instant endTime);

  /**
   * Converts a {@link ChannelSegmentDescriptor}, list of {@link WfdiscDao} and a list of files for
   * those wfdisc daos into a ChannelSegment
   *
