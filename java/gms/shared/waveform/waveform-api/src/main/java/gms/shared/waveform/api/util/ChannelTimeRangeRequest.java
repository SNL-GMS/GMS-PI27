...
/** A {@link Request} for {@link Channel}s by time range from the station definition endpoint */
@AutoValue
...
public abstract class ChannelTimeRangeRequest {
  ...
  public interface Builder {
    ...
    ChannelTimeRangeRequest.Builder setFacetingDefinition(
     ...
     */
    default ChannelTimeRangeRequest.Builder noFacetingDefinition() {
