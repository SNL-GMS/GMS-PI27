...
public final class WaveformTestFixtures {

  private static final SecureRandom random = new SecureRandom();
  private static final long SAMPLE_CNT_100 = 100;
  ...
  public static final Channel CHANNEL_NO_DATA =
      Channel.builder().setName("Real Channel Name One").setEffectiveAt(Instant.EPOCH).build();
  ...
  public static final ChannelSegment<Waveform> CHANNEL_SEGMENT_NO_CHANNEL_DATA =
      ChannelSegment.from(
          CHANNEL_NO_DATA,
          CHANNEL.getUnits(),
          List.of(epochStart100RandomSamples(CHANNEL.getNominalSampleRateHz())),
  ...
  public static final Waveform WAVEFORM_1 =
      Waveform.create(SEGMENT_START, SAMPLE_RATE, WAVEFORM_POINTS);
  ...
  public static Waveform epochStart100RandomSamples(double sampleRate) {
    return randomSamples0To1(Instant.EPOCH, sampleRate, SAMPLE_CNT_100);
  }
