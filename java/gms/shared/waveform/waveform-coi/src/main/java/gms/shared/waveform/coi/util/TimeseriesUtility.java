...
public final class TimeseriesUtility {
  ...
  public static <T extends Timeseries> List<T> filterEnclosed(List<T> series) {
    ...
    // By definition, 0 or 1 series will not have a contained series
    if (series.size() < 2) {
      return series;
    }
   ...
   * @return
   */
  private static List<Range<Instant>> computeSortedTimeRanges(
      Collection<? extends Timeseries> series) {
