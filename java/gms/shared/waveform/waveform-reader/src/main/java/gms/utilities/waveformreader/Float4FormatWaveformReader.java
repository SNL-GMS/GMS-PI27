...
public class Float4FormatWaveformReader implements WaveformReader {
   ...
   *
   * <p>VAX F: Mantissa 2 |S Exp | M1 MMMMMMMM|MMMMMMMM|SEEEEEEE|EMMMMMMM
   *
   * <p>IEEE Float: S Exp | M1 | Mantissa 2 SEEEEEEE|EMMMMMMM|MMMMMMMM|MMMMMMMM
   *
   * <p>E: Exponent M: Mantissa S: Sign
   *
   * @param f vax float
   * @return ieee float
   */
