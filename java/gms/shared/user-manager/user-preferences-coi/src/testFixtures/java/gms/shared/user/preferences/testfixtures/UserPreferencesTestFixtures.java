...
public final class UserPreferencesTestFixtures {
  ...
  private static final String REACT_COMPONENT_STRING1 =
      "%22componentName%22:%22lm-react-component%22,%22isClosable%22:true,";

  private static final String REORDER_ENABLED =
      "%22reorderEnabled%22:true%7D,%7B%22type%22:%22component%22,";

  private static final List<AudibleNotification> audibleNotifications =
      List.of(
          AudibleNotification.from(HEY_WAV, SystemMessageType.STATION_CAPABILITY_STATUS_CHANGED),
          AudibleNotification.from(LISTEN_WAV, SystemMessageType.STATION_NEEDS_ATTENTION));

  private static final List<AudibleNotification> audibleNotificationsUpdate =
      List.of(
          AudibleNotification.from(HEY_WAV, SystemMessageType.STATION_CAPABILITY_STATUS_CHANGED),
          AudibleNotification.from(HUSH_WAV, SystemMessageType.CHANNEL_MONITOR_TYPE_QUIETED),
          AudibleNotification.from(WATCH_OUT_WAV, SystemMessageType.STATION_NEEDS_ATTENTION));

  public static final UserPreferences USER_PREFERENCES_DEFAULT =
      UserPreferences.from(
          USER_ID,
          DEFAULT_LAYOUT_NAME,
          List.of(
              WorkspaceLayout.from(
                  DEFAULT_LAYOUT_NAME, List.of(UserInterfaceMode.ANALYST), LAYOUT_CONFIG_1)),
          new ArrayList<>(),
          Map.of("currentTheme", CURRENT_THEME));

  public static final UserPreferences USER_PREFERENCES_TWO =
      UserPreferences.from(
          USER_ID,
          DEFAULT_LAYOUT_NAME,
          List.of(
              WorkspaceLayout.from(
                  DEFAULT_LAYOUT_NAME, List.of(UserInterfaceMode.ANALYST), LAYOUT_CONFIG_2)),
          new ArrayList<>(),
          Map.of("currentTheme", CURRENT_THEME));

  public static final UserPreferences USER_PREFERENCES_AUDIBLE_DEFAULT =
      UserPreferences.from(
          USER_ID,
          DEFAULT_LAYOUT_NAME,
          List.of(
  ...
  public static final UserPreferences USER_PREFERENCES_AUDIBLE_UPDATE =
      UserPreferences.from(
          USER_ID,
          DEFAULT_LAYOUT_NAME,
          List.of(
              WorkspaceLayout.from(
                  DEFAULT_LAYOUT_NAME, List.of(UserInterfaceMode.ANALYST), LAYOUT_CONFIG_1)),
          audibleNotificationsUpdate,
          Map.of("currentTheme", CURRENT_THEME));

  public static final UserPreferences USER_PREFERENCES_AUDIBLE_TWO =
      UserPreferences.from(
          USER_ID,
          DEFAULT_LAYOUT_NAME,
          List.of(
  ...
  public static final String USER_PREFERENCES_JSON =
      "{\n"
          ...
          + "%22reorderEnabled%22:true,%22title%22:%22%22,%22openPopouts%22:%5B%5D,%22maximisedItemId%22:null%7D\""
          + "    },\n"
          + "    {\n"
