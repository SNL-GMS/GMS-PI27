 ...
 */
public final class DefaultReactorKafkaFluxSupplier<V> implements ReactorKafkaFluxSupplier<V> {

  private final KafkaReceiver<String, V> kafkaReceiver;

  private DefaultReactorKafkaFluxSupplier(KafkaReceiver<String, V> kafkaReceiver) {
    this.kafkaReceiver = kafkaReceiver;
  }

  public static <V> DefaultReactorKafkaFluxSupplier<V> create(
