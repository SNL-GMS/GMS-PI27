...
public class HttpStatus {
  ...
  public enum Code {
    ...
    NON_AUTHORITATIVE_INFORMATION(
        NON_AUTHORITATIVE_INFORMATION_203, "Non Authoritative Information"),
    ...
    PROXY_AUTHENTICATION_REQUIRED(
        PROXY_AUTHENTICATION_REQUIRED_407, "Proxy Authentication Required"),
    ...
    REQUEST_HEADER_FIELDS_TOO_LARGE(
        REQUEST_HEADER_FIELDS_TOO_LARGE_431, "Request Header Fields Too Large"),
    UNAVAILABLE_FOR_LEGAL_REASONS(
        UNAVAILABLE_FOR_LEGAL_REASONS_451, "Unavailable for Legal Reason"),
    ...
    NETWORK_AUTHENTICATION_REQUIRED(
        NETWORK_AUTHENTICATION_REQUIRED_511, "Network Authentication Required"),
    ;
    ...
    /**
     * Simple test against an code to determine if it falls into the <code>Success</code> message
     * category as defined in the <a href="http://tools.ietf.org/html/rfc1945">RFC 1945 -
     * HTTP/1.0</a>, and <a href="http://tools.ietf.org/html/rfc7231">RFC 7231 - HTTP/1.1</a>.
     *
    ...
    /**
     * Simple test against an code to determine if it falls into the <code>Client Error</code>
     * message category as defined in the <a href="http://tools.ietf.org/html/rfc1945">RFC 1945 -
     * HTTP/1.0</a>, and <a href="http://tools.ietf.org/html/rfc7231">RFC 7231 - HTTP/1.1</a>.
     *
    ...
    /**
     * Simple test against an code to determine if it falls into the <code>Server Error</code>
     * message category as defined in the <a href="http://tools.ietf.org/html/rfc1945">RFC 1945 -
     * HTTP/1.0</a>, and <a href="http://tools.ietf.org/html/rfc7231">RFC 7231 - HTTP/1.1</a>.
     *
  ...
  public static boolean isSuccess(int code) {
    return ((SUCCESS_MIN <= code) && (code <= SUCCESS_MAX));
  }

  /**
   * Simple test against an code to determine if it falls into the <code>Client Error</code> message
   * category as defined in the <a href="http://tools.ietf.org/html/rfc1945">RFC 1945 -
   * HTTP/1.0</a>, and <a href="http://tools.ietf.org/html/rfc7231">RFC 7231 - HTTP/1.1</a>.
   *
   * @param code the code to test.
  ...
  public static boolean isClientError(int code) {
    return ((CLIENT_ERROR_MIN <= code) && (code <= CLIENT_ERROR_MAX));
  }

  /**
   * Simple test against an code to determine if it falls into the <code>Server Error</code> message
   * category as defined in the <a href="http://tools.ietf.org/html/rfc1945">RFC 1945 -
   * HTTP/1.0</a>, and <a href="http://tools.ietf.org/html/rfc7231">RFC 7231 - HTTP/1.1</a>.
   *
   * @param code the code to test.
  ...
  public static boolean isServerError(int code) {
    return ((SERVER_ERROR_MIN <= code) && (code <= SERVER_ERROR_MAX));
  }
}
