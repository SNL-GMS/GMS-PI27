...
public class ChannelDao implements Serializable {
  ...
  @Embedded private OrientationDao orientationAngles;
  ...
  private static class Builder {
    ...
    public Builder withChannelBandType(ChannelBandType channelBandType) {
      this.channelBandType = channelBandType;
      return this;
    }

    public Builder withChannelInstrumentType(ChannelInstrumentType channelInstrumentType) {
      this.channelInstrumentType = channelInstrumentType;
      return this;
    }

    public Builder withChannelOrientationType(ChannelOrientationType channelOrientationType) {
    ...
    public Builder withChannelDataType(ChannelDataType channelDataType) {
    ...
    public Builder withLocation(LocationDao location) {
      this.location = location;
      return this;
    }

    public Builder withOrientationAngles(OrientationDao orientationAngles) {
  ...
  public static ChannelDao from(Channel channel) {
    ...
    var processingDefinition =
        jsonObjectMapper.valueToTree(channel.getProcessingDefinition()).toString();
    var processingMetadata =
        jsonObjectMapper.valueToTree(channel.getProcessingMetadata()).toString();
  ...
  public void setChannelBandType(ChannelBandType channelBandType) {
    this.channelBandType = channelBandType;
  }
  ...
  public void setChannelInstrumentType(ChannelInstrumentType channelInstrumentType) {
    this.channelInstrumentType = channelInstrumentType;
  }
  ...
  public void setChannelOrientationType(ChannelOrientationType channelOrientationType) {
    this.channelOrientationType = channelOrientationType;
  }
  ...
  public void setChannelDataType(ChannelDataType channelDataType) {
    this.channelDataType = channelDataType;
  }
  ...
  public void setOrientationAngles(OrientationDao orientationAngles) {
    this.orientationAngles = orientationAngles;
  }
