...
public class ReferenceResponseDao {
  ...
  @JoinTable(
      name = "reference_response_reference_source_response",
      joinColumns = {
        @JoinColumn(
            name = "reference_response_id",
            table = "reference_response",
            referencedColumnName = "id")
      },
      inverseJoinColumns = {
        @JoinColumn(
            name = "reference_source_response_id",
            table = "reference_source_response",
            referencedColumnName = "id")
      })
  ...
  @OneToOne(cascade = CascadeType.ALL)
  @JoinTable(
      name = "reference_response_reference_calibrations",
      joinColumns = {
        @JoinColumn(
            name = "reference_response_id",
            table = "reference_response",
  ...
  @OneToOne(cascade = CascadeType.ALL)
  @JoinTable(
      name = "reference_response_frequency_amplitude_phase",
  ...
  public ReferenceResponseDao(ReferenceResponse referenceResponse) {
    ...
    Preconditions.checkNotNull(
        referenceResponse, "Cannot create ReferenceResponseDao from null ReferenceResponse");
    ...
    this.sourceResponseDao =
        referenceResponse.getSourceResponse().map(ReferenceSourceResponseDao::from).orElse(null);
    this.referenceCalibrationDao =
        ReferenceCalibrationDao.from(
            referenceResponse.getReferenceCalibration().getCalibrationInterval(),
  ...
  public ReferenceResponse toCoi() {
    return ReferenceResponse.builder()
        ...
        .setFapResponse(
            this.getFrequencyAmplitudePhase().map(FrequencyAmplitudePhaseDao::toCoi).orElse(null))
        .build();
  }
  ...
  public void setSourceResponseDao(ReferenceSourceResponseDao sourceResponse) {
  ...
  public void setReferenceCalibrationDao(ReferenceCalibrationDao referenceCalibrationDao) {
  ...
  public int hashCode() {
    return Objects.hash(
        ...
        comment,
        sourceResponseDao,
        referenceCalibrationDao,
        frequencyAmplitudePhaseDao);
  }
