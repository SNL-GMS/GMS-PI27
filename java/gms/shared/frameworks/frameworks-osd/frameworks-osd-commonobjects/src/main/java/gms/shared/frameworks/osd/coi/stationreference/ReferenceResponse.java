...
public abstract class ReferenceResponse {
  ...
  public abstract static class Builder {
    ...
    @JsonProperty
    public abstract Builder setSourceResponse(@Nullable ReferenceSourceResponse sourceResponse);

    public Builder noSourceResponse() {
      return this.setSourceResponse(null);
    }

    public abstract Builder setReferenceCalibration(ReferenceCalibration referenceCalibration);

    @JsonProperty
    public abstract Builder setFapResponse(@Nullable FrequencyAmplitudePhase response);

    public Builder noFapResponse() {
      return this.setFapResponse(null);
    }

    abstract ReferenceResponse autoBuild();

    public ReferenceResponse build() {
      setReferenceResponseId(
