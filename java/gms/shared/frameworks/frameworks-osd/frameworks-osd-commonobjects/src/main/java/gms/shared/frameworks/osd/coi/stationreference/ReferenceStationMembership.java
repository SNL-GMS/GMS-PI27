...
public abstract class ReferenceStationMembership {
   ...
   */
  public static ReferenceStationMembership create(
      String comment,
      Instant actualChangeTime,
    ...
    var id =
        UUID.nameUUIDFromBytes(
            (stationId.toString() + siteId + status + actualChangeTime)
   ...
   */
  public static ReferenceStationMembership from(
      UUID id,
      String comment,
      Instant actualChangeTime,
      Instant systemChangeTime,
