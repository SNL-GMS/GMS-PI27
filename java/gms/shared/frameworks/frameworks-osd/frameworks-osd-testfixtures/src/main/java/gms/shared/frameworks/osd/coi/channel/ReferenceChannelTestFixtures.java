...
public class ReferenceChannelTestFixtures {
  ...
  private static final int SAMPLE_RATE_BOUND = 800;
  private static final double SAMPLE_RATE_FACTOR = 10;

  private ReferenceChannelTestFixtures() {}

  private static final ReferenceChannel asarAs01Bhz =
  ...
  private static final ReferenceChannel txarTx01Shz =
      ReferenceChannel.builder()
          .setName("TX01/SHZ")
          .setDataType(ChannelDataType.SEISMIC)
          .setBandType(ChannelBandType.SHORT_PERIOD)
  ...
  public static ReferenceChannel.Builder randomChannelBuilder() {
    ...
    return ReferenceChannel.builder()
        ...
        .setUnits(Units.COUNTS_PER_NANOMETER)
        .setNominalSampleRate((randomInt(SAMPLE_RATE_BOUND) / SAMPLE_RATE_FACTOR))
        ...
        .setPosition(RelativePosition.from(randomDouble(0.5), randomDouble(0.5), randomDouble(0.1)))
        .setAliases(List.of());
  }

  private static InformationSource randomInformationSource() {
    return InformationSource.from(randomUpperCase(3), Instant.EPOCH, randomUpperCase(10));
  }
