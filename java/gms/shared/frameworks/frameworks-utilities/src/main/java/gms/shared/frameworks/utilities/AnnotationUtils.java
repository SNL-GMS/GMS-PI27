...
public final class AnnotationUtils {
  ...
  public static String getComponentName(Class<?> clientClass) {
    return findClassAnnotation(clientClass, Component.class)
   ...
   */
  public static <A extends Annotation> Optional<A> findClassAnnotation(
    ...
    return StreamSupport.stream(
            ClassUtils.hierarchy(targetClass, Interfaces.INCLUDE).spliterator(), false)
  ...
  public static <A extends Annotation> Optional<A> findMethodAnnotation(
      Method targetMethod, Class<A> annotationClass) {
