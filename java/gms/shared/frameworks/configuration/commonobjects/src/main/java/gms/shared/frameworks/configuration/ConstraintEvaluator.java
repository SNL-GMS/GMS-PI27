...
final class ConstraintEvaluator {
  ...
  /**
   * Determines whether the {@link Constraint} is satisfied by the {@link Selector}. This occurs if
   * the {@link Constraint#getCriterion()} is the same as the {@link Selector#getCriterion()} and
