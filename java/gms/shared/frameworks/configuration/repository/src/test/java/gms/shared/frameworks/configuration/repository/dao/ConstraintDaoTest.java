...
class ConstraintDaoTest {
  ...
  public void init() {
    ...
    ConfigurationOption co =
        ConfigurationOption.from("config-option-test", new ArrayList<>(), new LinkedHashMap<>());
  ...
  void testEquals() {
    ...
    assertTrue(defaultConstraintDao.equals(constraintDao), "Equals not correct for ConstraintDao");
  }
  ...
  void testHashCode() {
    ...
    assertTrue(
        constraintDaoSet.contains(defaultConstraintDao), "HashCode not correct for ConstraintDao");
  }
}
