...
class BicubicSplineFeaturePredictorConfigurationTest {
  ...
  void testHappyConfig() {
    ...
    var bicubicSplineConfiguration =
        new BicubicSplineFeaturePredictorConfiguration(configurationConsumerUtility);

    var actualDefinition =
        bicubicSplineConfiguration.getCurrentBicubicSplineFeaturePredictorDefinition();

    Assertions.assertNotNull(actualDefinition);

    Assertions.assertFalse(actualDefinition.isExtrapolate());
