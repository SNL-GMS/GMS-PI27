...
class IaspeiTravelTimeLookupTableConfigurationTest {
  ...
  void testHappyConfig() {
    ...
    var IaspeiTravelTimeLookupTableConfiguration =
        new IaspeiTravelTimeLookupTableConfiguration(configurationConsumerUtility, systemConfig);
    ...
    Assertions.assertEquals(
        "feature-prediction-models", actualDefinition.getFileDescriptor().getBucket());

    Assertions.assertEquals("travel-time/iaspei/", actualDefinition.getFileDescriptor().getKey());
  }
