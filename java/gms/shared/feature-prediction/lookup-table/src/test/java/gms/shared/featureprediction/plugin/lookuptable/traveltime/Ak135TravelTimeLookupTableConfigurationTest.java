...
class Ak135TravelTimeLookupTableConfigurationTest {
  ...
  void testHappyConfig() {
    ...
    var ak135TravelTimeLookupTableConfiguration =
        new Ak135TravelTimeLookupTableConfiguration(configurationConsumerUtility, systemConfig);
    ...
    Assertions.assertEquals("travel-time/ak135/", actualDefinition.getFileDescriptor().getKey());
  }
