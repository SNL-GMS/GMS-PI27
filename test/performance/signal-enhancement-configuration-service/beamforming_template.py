...
class BeamformingTemplate(PerformanceTestBase):
    """
    Stress test the signal-enhancement-configuration/beamforming-template endpoint
    The default inut file is beamforming_template.json
    ...
    """
    SERVICE_ENDPOINT_URL = "/signal-enhancement-configuration-service/signal-enhancement-configuration/beamforming-template"
    DEFAULT_INPUT_FILE = "beamforming_template.json"
    ...
    def rewrite_request_body(self, request_body, iter_num):
        ...
        #recurse through all channels in the request, chunking each request into num_stations sub_requests
