...
class DefaultStationsByAmplitudeType(PerformanceTestBase):
    """
    Stress test the signal-feature-measurement-configuration/default-stations-by-amplitude-type
    The default inut file is amplitude-measurement-type-request11.json
    """
    SERVICE_ENDPOINT_URL = "/signal-feature-measurement-configuration-service/signal-feature-measurement-configuration/default-stations-by-amplitude-type"
...
if __name__ == "__main__":
    test = DefaultStationsByAmplitudeType()
    try:        
        test.validation()
