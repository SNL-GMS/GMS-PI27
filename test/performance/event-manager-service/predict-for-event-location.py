...
class PredictFeaturesForEventLocation(PerformanceTestBase):
    """
    Stress test the /event-manager-service/event/predict-for-event-location endpoint
    """
    SERVICE_ENDPOINT_URL = "/event-manager-service/event/predict-for-event-location"
    ...
    DEFAULT_INPUT_FILE = "predict-for-event-location.json"
...
if __name__ == "__main__":
    test = PredictFeaturesForEventLocation()
    try:
        test.validation()
